...
class RigByped(rigBase.RigBase):
    ...
    def build(self):
        ...
        self.l_toes.set_parent(self.l_leg, create_hierarchy_joints=True, output_joint_rig=self.rig_output)
        self.r_toes.set_parent(self.r_leg, create_hierarchy_joints=True, output_joint_rig=self.rig_output)
